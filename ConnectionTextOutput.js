var ConnectionTextOutput = {
    ...
    getRecursiveText: function(connection, level){
        ...
        if(connection.subConnections.length > 0 && level < document.forms['form1'].elements['level'].value && connection.action == "add"){
            ...
            //connectionString += connection.id + "-->" + connection.subConnections;
            ...
            //If all sub connections are removed from the map, this connection shouldnt be displayed in the Textoutput, therefor it returns an empty String
